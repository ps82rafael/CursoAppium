package br.ps.rafael.appium.core;
...
public class BasePage {
	...
	public String obterTexte(By by) {
	...
	public void clicarPorTexto(String testo) {
		clicar(By.xpath("//*[@text='" + testo + "']"));
	...
	public boolean existeElemetoPorTexto(String texto) {
	...
	public String obterTituloAlerta() {
		return obterTexte(By.id("android:id/alertTitle"));

	}

	public String obterMensagemAlerta() {
		return obterTexte(By.id("android:id/message"));
	}
